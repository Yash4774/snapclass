...
from src_screens.database.db import check_teacher_exists, create_teacher, teacher_login, get_teacher_subjects, get_attendance_for_teacher
from style_base_layout import style_background_dashboard, style_base_layout
...
from pipeliness.face_pipeline import predict_attendance
import numpy as np
import pandas as pd
...
def teacher_tab_take_attendance():
    ...
    st.markdown(
        """
        <h2 style='color:black; font-size:30px; font-weight:400;'>
            Take AI Attendance
        </h2>
        """,
        unsafe_allow_html=True
    ...
    if st.session_state.attendance_images:
        st.markdown(
            "<h2><span style='color:black;'>Added Photos</h2>",
            unsafe_allow_html=True
)
        ...
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
            ...
            with st.spinner('Deep scanning classroom photos...'):
                ...
                if 'voice_attendance_results' in st.session_state:
                    df_results, attendance_to_log = st.session_state.voice_attendance_results
                    attendance_result_dialog(df_results, attendance_to_log)
...
def teacher_screen_login():
    ...
    st.markdown(
            """
            <h2 style='color:black; font-size:50px; font-weight:800;white-space:nowrap;'>
...
def teacher_screen_register():
    ...
    st.markdown(
    """
    <h2 style='color:black; font-size:40px; font-weight:800;white-space:nowrap'>
