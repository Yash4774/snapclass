...
import pandas as pd
from src.src_screens.components.attendance_result_dialog import show_attendance_result
    ...
    if st.button('Analyze Audio', width='stretch', type='primary'):
        ...
        with st.spinner('Processing Audio data...'):
            ...
            if not candidate_dict:
                st.error('No enrolled students have voice profile registerd. Please ensure students have recorded their voice for attendance.')
                return
